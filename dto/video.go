...
type VideoRequest struct {
	...
	Images         []string       `json:"images,omitempty"`                                                                                                                                                      // Multiple reference images; AutoDL minimax-h3-* workflows support up to 9 images
	Audio          string         `json:"audio,omitempty" example:"https://example.com/audio.mp3"`                                                                                                               // Single audio input (URL/Base64)
	Audios         []string       `json:"audios,omitempty"`                                                                                                                                                      // Multiple reference audios; AutoDL minimax-h3-* workflows support up to 3 tracks
	Resolution     string         `json:"resolution,omitempty" example:"768p竖"`                                                                                                                                  // AutoDL output resolution
	Duration       float64        `json:"duration" example:"5.0"`                                                                                                                                                // Video duration (seconds)
	AudioDuration  *int           `json:"audio_duration,omitempty" example:"5"`                                                                                                                                  // AutoDL minimax-h3-lipsync duration (seconds)
